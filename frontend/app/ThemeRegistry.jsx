...
export default function ThemeRegistry({ children }) {
  ...
  const theme = useMemo(() => createTheme({
    ...
    typography: {
      ...
      h1: { fontFamily: 'Outfit, sans-serif', fontWeight: 900, fontSize: 'clamp(1.75rem, 4vw, 2.5rem)', letterSpacing: '-0.02em' },
      h2: { fontFamily: 'Outfit, sans-serif', fontWeight: 800, fontSize: 'clamp(1.5rem, 3.5vw, 2rem)', letterSpacing: '-0.02em' },
      h3: { fontFamily: 'Outfit, sans-serif', fontWeight: 800, fontSize: 'clamp(1.25rem, 3vw, 1.75rem)' },
      h4: { fontFamily: 'Outfit, sans-serif', fontWeight: 700, fontSize: 'clamp(1.1rem, 2.5vw, 1.5rem)' },
      h5: { fontFamily: 'Outfit, sans-serif', fontWeight: 700, fontSize: 'clamp(1rem, 2vw, 1.25rem)' },
      h6: { fontFamily: 'Outfit, sans-serif', fontWeight: 700, fontSize: 'clamp(0.95rem, 1.8vw, 1.1rem)' },
      body1: { fontSize: '0.95rem', lineHeight: 1.5 },
      body2: { fontSize: '0.85rem', lineHeight: 1.45 },
      caption: { fontSize: '0.75rem', fontWeight: 700 },
